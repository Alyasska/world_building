...
export default function LoreEntriesError({ error, reset }: Props) {
  return (
    <PageContainer narrow>
      <SectionHeader title={ui.loreEntries.title} description={ui.loreEntries.errorSectionDescription} />
      <div className="empty-state">
        <h2 className="empty-state__title">{ui.loreEntries.loadFailed}</h2>
